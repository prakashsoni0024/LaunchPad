...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-8 md:h-16'>

      <Link className="logo font-bold text-lg flex justify-center items-center" href={"/"}>
        {/* <img className='invertImg' src="tea.gif" width={44} alt="" /> */}
        <span className='text-xl md:text-base my-3 md:my-0'>LaunchPad</span>
      </Link>
