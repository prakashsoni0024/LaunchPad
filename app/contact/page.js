    ...
    <div>
      ...
      <div className='min-h-screen flex flex-col justify-center items-center bg-gray-900 text-white px-4'>
        ...
        <p className='text-lg md:text-xl mb-8 text-center max-w-3xl'>
          Have questions or need assistance? We’re here to help! Reach out to the LaunchPad team anytime, 
        ...
        <Link href={"/"}>
          <button
            ...
            text-sm px-5 py-2.5 text-center me-2 mb-2 mt-8"
          >
            Go Home
          </button>
        </Link> 
...
export const metadata = {
  ...
  description: 'Get in touch with the LaunchPad team for support, inquiries, or feedback.',
}
