...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "Login - LaunchPad"; 
    console.log(session)
    if (session) {
  ...
  return (
    <div className="text-white py-14 container mx-auto">
      ...
      <div className="flex flex-col items-center gap-2 min-h-screen  p-10">
        <button className="flex w-64 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
